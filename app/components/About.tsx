  ...
  return (
    <div id="about" className="w-full px-[12%] py-10 scroll-mt-20">
      ...
      <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
        <div className="w-64 sm:w-80 rounded-3xl max-w-mone">
          <Image
            alt="user"
        ...
        <div className="flex-1">
          ...
          <ul className="grid grid-cols-1 sm:grid-cols-3 gap-3 max-w-2xl">
            {infoList.map(({ icon, iconDark, title, description }, index) => (
              <li
                key={index}
                className="border-[0.5px] border-gray-400 rounded-xl p-6 transform cursor-pointer hover:bg-[#fcf4ff] hover:-translate-y-1 
